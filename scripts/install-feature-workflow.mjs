...
if (fs.existsSync('.git')) {
  ...
  console.log(
    'Not currently inside a Git repository; run npm run workflow:install after copying these files into the repo.',
  );
}

console.log(
  'Feature workflow installation complete. Restart Codex so project hooks/configuration reload.',
);
